...
from .infinitetalk.nodes import NODE_CLASS_MAPPINGS as INFINITETALK_NODE_CLASS_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as INFINITETALK_NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(INFINITETALK_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(INFINITETALK_NODE_DISPLAY_NAME_MAPPINGS)
